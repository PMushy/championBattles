...
@NoArgsConstructor
public class Rogue extends AbstractChampion {
    public static final Random random = new Random();

    public Rogue(String name, ChampionStatistics stats, Type type) {
    ...
    public int getPower() {
        ...
        } else return (stats.getAttackDamage() + stats.getAbilityPower()) * 2;
    }
